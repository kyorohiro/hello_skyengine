...
ProgramScree progScene = new ProgramScree();
void main() {
...
class StartScreen extends TinyDisplayObject {
  ...
  StartScreen() {
    ...
    child.add(button);
    f.loadImage("assets/bg_start.png").then((TinyImage i) {
      img = i;
    });
  }
...
class GameScree extends TinyDisplayObject {
  TinyImage img = null;
  GameScree() {
    f.loadImage("assets/bg_play.png").then((TinyImage i) {
      img = i;
    });
    {
...
class ProgramScree extends TinyDisplayObject {
  TinyImage img = null;
  ProgramScree() {
    f.loadImage("assets/bg_prog.png").then((TinyImage i) {
      img = i;
    });
    {
      TinyButton button = new TinyButton("back_button", 200.0, 120.0, onPush);
